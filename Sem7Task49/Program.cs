...
//Метод заменяет четные элементы массива на их квадраты
...
Update2DArray(arr2D); //Изменение элементов массива
Print2DArrayColor(arr2D); //Печать измененного мссива массива