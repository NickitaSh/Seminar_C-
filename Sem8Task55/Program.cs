// Задача №55
//Задайте двумерный массив и поменяйте местами строки и столбцы
...
//Метод проверки можно ли поменять строки и столбцы местами(квадратный ли массив)
bool TTest(int[,]arr)
{
...
int[,] arr2D = Fill2DArray(row, column, 1, 100); //Заполнение массива   
